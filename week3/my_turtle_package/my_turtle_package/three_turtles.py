...
class TurtleController(Node):
    def __init__(self):
        ...
        # Square motion params
        self.square_steps = [
            (1.0, 0.0, 20),   # Side 1
            (0.0, 1.57, 10),  # Turn 90 deg
            (1.0, 0.0, 20),   # Side 2
            (0.0, 1.57, 10),  # Turn
            (1.0, 0.0, 20),   # Side 3
            (0.0, 1.57, 10),  # Turn
    ...
    def spawn_turtles(self):
        ...
        # Spawn turtle3 at x=8, y=8
        req3 = Spawn.Request()
        req3.x = 7.0
        req3.y = 8.0
        req3.name = 'turtle3'
        client.call_async(req3)
